...
STAT_DEFINITIONS: tuple[StatDefinition, ...] = (
    ...
    StatDefinition("possession_percentage", "Possession %", "%"),
    ...
    StatDefinition("crossbar_hits", "Crossbar Hits"),
    ...
    StatDefinition("time_on_wall", "Time on Wall", "s"),
    ...
    StatDefinition("team_possession_percentage", "Team Possession %", "%", False),
    ...
    StatDefinition("team_crossbar_hits", "Team Crossbar Hits", "", False),
    ...
    StatDefinition("team_time_on_wall", "Team Time on Wall", "s", False),
